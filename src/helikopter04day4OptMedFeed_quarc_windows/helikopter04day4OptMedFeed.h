 ...
 */
#ifndef RTW_HEADER_helikopter04day4OptMedFeed_h_
#define RTW_HEADER_helikopter04day4OptMedFeed_h_
#ifndef helikopter04day4OptMedFeed_COMMON_INCLUDES_
# define helikopter04day4OptMedFeed_COMMON_INCLUDES_
#include <math.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helikopter04day4OptMedFeed_COMMON_INCLUDES_ */

#include "helikopter04day4OptMedFeed_types.h"
...
#define helikopter04day4OptMedFeed_rtModel RT_MODEL_helikopter04day4OptMed
...
typedef struct {
  ...
  real_T Sat;                          /* '<S2>/Sat' */
  real_T Add_f;                        /* '<S2>/Add' */
} BlockIO_helikopter04day4OptMedF;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T HILInitialize_AIMinimums[16]; /* '<Root>/HIL Initialize' */
  real_T HILInitialize_AIMaximums[16]; /* '<Root>/HIL Initialize' */
  ...
  int32_T HILInitialize_ClockModes[6]; /* '<Root>/HIL Initialize' */
...
} D_Work_helikopter04day4OptMedFe;
...
#define rtB                            helikopter04day4OptMedFeed_B
#define BlockIO                        BlockIO_helikopter04day4OptMedF
#define rtX                            helikopter04day4OptMedFeed_X
#define ContinuousStates               ContinuousStates_helikopter04da
#define rtP                            helikopter04day4OptMedFeed_P
#define Parameters                     Parameters_helikopter04day4OptM
#define rtDWork                        helikopter04day4OptMedFee_DWork
#define D_Work                         D_Work_helikopter04day4OptMedFe

/* Parameters (auto storage) */
struct Parameters_helikopter04day4OptM_ {
  ...
  real_T Saturation_LowerSat;          /* Expression: -10
                                        * Referenced by: '<S1>/Saturation'
                                        */
  real_T Saturation_UpperSat_p;        /* Expression: 50*pi/180
                                        * Referenced by: '<S3>/Saturation'
                                        */
  real_T Saturation_LowerSat_b;        /* Expression: -50*pi/180
                                        * Referenced by: '<S3>/Saturation'
                                        */
  ...
  real_T SatB_LowerSat;                /* Expression: -5
                                        * Referenced by: '<S2>/Sat B'
                                        */
  real_T Gain1_Gain_e;                 /* Expression: V_f_eq
  ...
  real_T Constant_Value_p;             /* Expression: 0.5
                                        ...
                                        */
  int32_T HILInitialize_CKChannels[6]; /* Computed Parameter: HILInitialize_CKChannels
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  int32_T HILInitialize_CKModes;       /* Computed Parameter: HILInitialize_CKModes
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  int32_T HILInitialize_EIInitial;     /* Computed Parameter: HILInitialize_EIInitial
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  uint32_T HILInitialize_AIChannels[16];/* Computed Parameter: HILInitialize_AIChannels
                                         * Referenced by: '<Root>/HIL Initialize'
                                         */
...
struct RT_MODEL_helikopter04day4OptMed {
  const char_T *path;
...
extern Parameters_helikopter04day4OptM helikopter04day4OptMedFeed_P;

/* Block signals (auto storage) */
extern BlockIO_helikopter04day4OptMedF helikopter04day4OptMedFeed_B;

/* Continuous states (auto storage) */
extern ContinuousStates_helikopter04da helikopter04day4OptMedFeed_X;

/* Block states (auto storage) */
extern D_Work_helikopter04day4OptMedFe helikopter04day4OptMedFee_DWork;

/* Model entry point functions */
extern void helikopter04day4OptMedFeed_initialize(boolean_T firstTime);
extern void helikopter04day4OptMedFeed_output(int_T tid);
extern void helikopter04day4OptMedFeed_update(int_T tid);
extern void helikopter04day4OptMedFeed_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_helikopter04day4OptMed *helikopter04day4OptMedFeed_M;
 ...
 *
 * '<Root>' : helikopter04day4OptMedFeed
 * '<S1>'   : helikopter04day4OptMedFeed/Elevasjonskontroller
 * '<S2>'   : helikopter04day4OptMedFeed/Heli 3D
 * '<S3>'   : helikopter04day4OptMedFeed/Pitch-kontroller
 * '<S4>'   : helikopter04day4OptMedFeed/V_d//V_s --> V_f//V_b
 */
#endif                                 /* RTW_HEADER_helikopter04day4OptMedFeed_h_ */
