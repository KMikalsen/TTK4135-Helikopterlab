...
typedef helikopter04_rtModel RT_MODEL;

/*====================*
 * External functions *
 *====================*/
extern RT_MODEL * helikopter04(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(helikopter04_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv, "shmem://helikopter04:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: helikopter04 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
