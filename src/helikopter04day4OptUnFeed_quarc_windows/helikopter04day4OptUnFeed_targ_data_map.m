  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (helikopter04day4OptUnFeed_P)
    ;%
      section.nData     = 46;
      section.data(46)  = dumData; %prealloc
      
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_OOStart
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_OOEnter
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_OOTerminate
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_OOExit
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 3;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_AIHigh
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 4;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_AILow
	  ...
	  ;% helikopter04day4OptUnFeed_P.KalibrerElev_Gain
	  ...
	  ;% helikopter04day4OptUnFeed_P.Constant1_Value
	  ...
	  ;% helikopter04day4OptUnFeed_P.KalibrerVandring_Gain
	  ...
	  ;% helikopter04day4OptUnFeed_P.KalibrerPitch_Gain
	  ...
	  ;% helikopter04day4OptUnFeed_P.Saturation_UpperSat_c
	  ...
	  ;% helikopter04day4OptUnFeed_P.K_pd_Gain
	  ...
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_CKChannels
	  section.data(1).logicalSrcIdx = 51;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_CKModes
	  section.data(2).logicalSrcIdx = 52;
	  section.data(2).dtTransOffset = 6;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_EIInitial
	  ...
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_AIChannels
	  section.data(1).logicalSrcIdx = 54;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_AOChannels
	  section.data(2).logicalSrcIdx = 55;
	  section.data(2).dtTransOffset = 16;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_EIQuadrature
	  section.data(3).logicalSrcIdx = 56;
	  section.data(3).dtTransOffset = 20;
	
	  ;% helikopter04day4OptUnFeed_P.HILReadEncoder_Channels
	  section.data(4).logicalSrcIdx = 57;
	  section.data(4).dtTransOffset = 21;
	
	  ;% helikopter04day4OptUnFeed_P.HILWriteAnalog_Channels
	  ...
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_Active
	  section.data(1).logicalSrcIdx = 59;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_CKPStart
	  section.data(2).logicalSrcIdx = 60;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_CKPEnter
	  section.data(3).logicalSrcIdx = 61;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_AIPStart
	  section.data(4).logicalSrcIdx = 62;
	  section.data(4).dtTransOffset = 3;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_AIPEnter
	  section.data(5).logicalSrcIdx = 63;
	  section.data(5).dtTransOffset = 4;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_AOPStart
	  section.data(6).logicalSrcIdx = 64;
	  section.data(6).dtTransOffset = 5;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_AOPEnter
	  section.data(7).logicalSrcIdx = 65;
	  section.data(7).dtTransOffset = 6;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_AOStart
	  section.data(8).logicalSrcIdx = 66;
	  section.data(8).dtTransOffset = 7;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_AOEnter
	  section.data(9).logicalSrcIdx = 67;
	  section.data(9).dtTransOffset = 8;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_AOTerminate
	  section.data(10).logicalSrcIdx = 68;
	  section.data(10).dtTransOffset = 9;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_AOExit
	  section.data(11).logicalSrcIdx = 69;
	  section.data(11).dtTransOffset = 10;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_AOReset
	  section.data(12).logicalSrcIdx = 70;
	  section.data(12).dtTransOffset = 11;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_DOPStart
	  section.data(13).logicalSrcIdx = 71;
	  section.data(13).dtTransOffset = 12;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_DOPEnter
	  section.data(14).logicalSrcIdx = 72;
	  section.data(14).dtTransOffset = 13;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_DOStart
	  section.data(15).logicalSrcIdx = 73;
	  section.data(15).dtTransOffset = 14;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_DOEnter
	  section.data(16).logicalSrcIdx = 74;
	  section.data(16).dtTransOffset = 15;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_DOTerminate
	  section.data(17).logicalSrcIdx = 75;
	  section.data(17).dtTransOffset = 16;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_DOExit
	  section.data(18).logicalSrcIdx = 76;
	  section.data(18).dtTransOffset = 17;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_DOReset
	  section.data(19).logicalSrcIdx = 77;
	  section.data(19).dtTransOffset = 18;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_EIPStart
	  section.data(20).logicalSrcIdx = 78;
	  section.data(20).dtTransOffset = 19;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_EIPEnter
	  section.data(21).logicalSrcIdx = 79;
	  section.data(21).dtTransOffset = 20;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_EIStart
	  section.data(22).logicalSrcIdx = 80;
	  section.data(22).dtTransOffset = 21;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_EIEnter
	  section.data(23).logicalSrcIdx = 81;
	  section.data(23).dtTransOffset = 22;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_POPStart
	  section.data(24).logicalSrcIdx = 82;
	  section.data(24).dtTransOffset = 23;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_POPEnter
	  section.data(25).logicalSrcIdx = 83;
	  section.data(25).dtTransOffset = 24;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_POStart
	  section.data(26).logicalSrcIdx = 84;
	  section.data(26).dtTransOffset = 25;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_POEnter
	  section.data(27).logicalSrcIdx = 85;
	  section.data(27).dtTransOffset = 26;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_POTerminate
	  section.data(28).logicalSrcIdx = 86;
	  section.data(28).dtTransOffset = 27;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_POExit
	  section.data(29).logicalSrcIdx = 87;
	  section.data(29).dtTransOffset = 28;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_POReset
	  section.data(30).logicalSrcIdx = 88;
	  section.data(30).dtTransOffset = 29;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_OOReset
	  section.data(31).logicalSrcIdx = 89;
	  section.data(31).dtTransOffset = 30;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_DOInitial
	  section.data(32).logicalSrcIdx = 90;
	  section.data(32).dtTransOffset = 31;
	
	  ;% helikopter04day4OptUnFeed_P.HILInitialize_DOFinal
	  section.data(33).logicalSrcIdx = 91;
	  section.data(33).dtTransOffset = 32;
	
	  ;% helikopter04day4OptUnFeed_P.HILReadEncoder_Active
	  section.data(34).logicalSrcIdx = 92;
	  section.data(34).dtTransOffset = 33;
	
	  ;% helikopter04day4OptUnFeed_P.HILWriteAnalog_Active
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (helikopter04day4OptUnFeed_B)
    ;%
      section.nData     = 13;
	  ...
	  ;% helikopter04day4OptUnFeed_B.Add
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	  ...
	  ;% helikopter04day4OptUnFeed_B.Add1
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 3;
	  ...
	  ;% helikopter04day4OptUnFeed_B.SatB
	  section.data(11).logicalSrcIdx = 10;
	  section.data(11).dtTransOffset = 10;
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (helikopter04day4OptUnFeed_DWork)
    ;%
      section.nData     = 6;
      section.data(6)  = dumData; %prealloc
      
	  ;% helikopter04day4OptUnFeed_DWork.HILInitialize_AIMinimums
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helikopter04day4OptUnFeed_DWork.HILInitialize_AIMaximums
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 16;
	
	  ;% helikopter04day4OptUnFeed_DWork.HILInitialize_AOMinimums
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 32;
	
	  ;% helikopter04day4OptUnFeed_DWork.HILInitialize_AOMaximums
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 36;
	
	  ;% helikopter04day4OptUnFeed_DWork.HILInitialize_AOVoltages
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 40;
	
	  ;% helikopter04day4OptUnFeed_DWork.HILWriteAnalog_Buffer
	  section.data(6).logicalSrcIdx = 5;
	  ...
	  ;% helikopter04day4OptUnFeed_DWork.HILReadEncoder_PWORK
	  section.data(1).logicalSrcIdx = 6;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helikopter04day4OptUnFeed_DWork.ToWorkspace_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 7;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helikopter04day4OptUnFeed_DWork.ToWorkspace1_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 8;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helikopter04day4OptUnFeed_DWork.ToWorkspace2_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 9;
	  section.data(4).dtTransOffset = 3;
	
	  ;% helikopter04day4OptUnFeed_DWork.ToWorkspace3_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 10;
	  section.data(5).dtTransOffset = 4;
	
	  ;% helikopter04day4OptUnFeed_DWork.ToWorkspace4_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 11;
	  section.data(6).dtTransOffset = 5;
	
	  ;% helikopter04day4OptUnFeed_DWork.ToWorkspace5_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 12;
	  section.data(7).dtTransOffset = 6;
	
	  ;% helikopter04day4OptUnFeed_DWork.elevasion_output_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 13;
	  section.data(8).dtTransOffset = 7;
	
	  ;% helikopter04day4OptUnFeed_DWork.pitch_output_PWORK.LoggedData
	  section.data(9).logicalSrcIdx = 14;
	  section.data(9).dtTransOffset = 8;
	
	  ;% helikopter04day4OptUnFeed_DWork.travel_PWORK.LoggedData
	  ...
	  ;% helikopter04day4OptUnFeed_DWork.Elevasjon_PWORK.LoggedData
	  section.data(13).logicalSrcIdx = 18;
	  section.data(13).dtTransOffset = 12;
	
	  ;% helikopter04day4OptUnFeed_DWork.Pitch_PWORK.LoggedData
	  section.data(14).logicalSrcIdx = 19;
	  section.data(14).dtTransOffset = 13;
	
	  ;% helikopter04day4OptUnFeed_DWork.Vandring_PWORK.LoggedData
	  section.data(15).logicalSrcIdx = 20;
	  section.data(15).dtTransOffset = 14;
	
	  ;% helikopter04day4OptUnFeed_DWork.Bakmotorvolts_PWORK.LoggedData
	  section.data(16).logicalSrcIdx = 21;
	  section.data(16).dtTransOffset = 15;
	
	  ;% helikopter04day4OptUnFeed_DWork.Frontmotorvolt_PWORK.LoggedData
	  section.data(17).logicalSrcIdx = 22;
	  section.data(17).dtTransOffset = 16;
	
	  ;% helikopter04day4OptUnFeed_DWork.HILWriteAnalog_PWORK
	  ...
	  ;% helikopter04day4OptUnFeed_DWork.HILInitialize_ClockModes
	  section.data(1).logicalSrcIdx = 24;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helikopter04day4OptUnFeed_DWork.HILReadEncoder_Buffer
  ...
  targMap.checksum0 = 1430648864;
  targMap.checksum1 = 2764951855;
  targMap.checksum2 = 1928705609;
  targMap.checksum3 = 2259670327;
